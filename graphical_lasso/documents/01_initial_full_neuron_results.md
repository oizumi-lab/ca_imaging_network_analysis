...
- Exact native-support sparsity: `sparsity_summary.csv`
- Figures: `graphical_lasso/results/02_network_comparison/figures/`

The interactive sparsity panels are generated by
`graphical_lasso/scripts/03_display_graph_sparsity.py` and saved as
`sparsity_mouse01_sleep.png` and `sparsity_mouse05_ane.png`.
