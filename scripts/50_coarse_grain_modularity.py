# %% [markdown]
# # 50 · Mesoscale modularity: coarse-graining across spatial scales (paper Fig. 7)
#
# Scripts 20/30 measured modularity at **single-cell** resolution and found it
...
GAMMA = 1.0
N_RUNS = 20       # Louvain runs per window; take max-Q (paper: 200)
N_WINDOWS = 2     # windows per state
MAX_NEURONS = 2000  # subsample active neurons for speed; None = all (like the paper)
