...
## Dataset version 3 (CC-BY 4.0)
- RIKEN neurodata portal: https://neurodata.riken.jp/id/20260708-001

## Reference code (MATLAB)
- https://github.com/oizumi-lab/mouse_network_2P — full analysis pipeline used in
  the paper. The Python tutorial notebooks provide the loading and organization
