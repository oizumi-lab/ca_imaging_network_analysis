function [SWP, sw_ness, delta_C, delta_L, each_eff, C_coef, reg_path, rand_path, net_path, rand_clus] = small_world_propensity(A, varargin)
...
%2021.07.19 計算が早い方法に変更
[reg_path, ~]         = characteristic_path_length_w(W_reg);
[rand_path, ~]        = characteristic_path_length_w(W_rand);
[net_path, each_eff]  = characteristic_path_length_w(W);
...
C_coef    = clustering_coef_matrix(W, varargin{1});
net_clus  = mean(C_coef);
